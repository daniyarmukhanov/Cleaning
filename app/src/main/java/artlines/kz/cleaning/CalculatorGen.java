...
public class CalculatorGen extends ActionBarActivity {
    boolean authorized;
    int sum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculator_gen);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myPref.edit().putString("type", "Генеральная уборка").commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_calculator_gen, menu);
        return true;
    }
